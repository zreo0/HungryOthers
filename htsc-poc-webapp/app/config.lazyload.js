    ...
    .config([
        '$ocLazyLoadProvider', function ($ocLazyLoadProvider) {
            $ocLazyLoadProvider.config({
                ...
                modules: [
                    {
                        name: 'renderteam.collapsibleTree',
                        files: [
                            'lib/collapsible-tree/d3.min.js',
                            'lib/collapsible-tree/angular-d3-collapsible-tree.min.css',
                            'lib/collapsible-tree/angular-d3-collapsible-tree.js'
                        ]
                    },
                    {
                        name: 'toaster',
